...
public class RoleController {
    ...
    public R index(
        ...
        if(!StringUtils.isEmpty(roleQueryVo.getBegin())) {
            wrapper.ge("gmt_create",roleQueryVo.getBegin());
        }
        if(!StringUtils.isEmpty(roleQueryVo.getEnd())) {
            wrapper.le("gmt_create",roleQueryVo.getEnd());
        }
