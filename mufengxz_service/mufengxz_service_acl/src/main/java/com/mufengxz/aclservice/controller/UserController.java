...
public class UserController {
    ...
    public R index(
        ...
        if(!StringUtils.isEmpty(userQueryVo.getBegin())) {
            wrapper.ge("gmt_create",userQueryVo.getBegin());
        }
        if(!StringUtils.isEmpty(userQueryVo.getEnd())) {
            wrapper.le("gmt_create",userQueryVo.getEnd());
        }
