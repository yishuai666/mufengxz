...
const refreshTabs=()=>{
  console.log("store.state.editableTabsValue="+store.state.editableTabsValue)
...
watch(editableTabsValue,()=>{
  console.log("变化了："+editableTabsValue.value)
  store.state.editableTabsValue=editableTabsValue.value
  console.log("store.state.editableTabsValue2="+store.state.editableTabsValue)
